            ...
            <div className="w-full overflow-x-auto rounded-xl border border-[var(--color-surface-200)] bg-[var(--color-surface-50)]" style={{ maxHeight: 'calc(100vh - 280px)' }}>
                ...
                <thead className="sticky top-0 bg-[var(--table-header)] shadow-[0_1px_0_0_var(--color-surface-200)] z-10">
                    <tr>
                        ...
                        {!hiddenCols['setter'] && <th className="px-5 py-4 font-semibold th-muted uppercase tracking-wider text-xs min-w-[240px]">Setter</th>}
                        ...
                        {!hiddenCols['esito'] && <th className="px-5 py-4 font-semibold text-yellow-500/60 uppercase tracking-wider text-xs min-w-[130px] bg-yellow-500/5 border-r border-[var(--color-surface-200)]">Esito Setter</th>}
