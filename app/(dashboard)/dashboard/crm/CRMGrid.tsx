...
export default function CRMGrid({ leads, stages, members, selectedLeads, onToggleLeadSelect, onToggleAllSelect, onLeadClick, onAssignLead, onAssignSetter, onAssignCloser, onUpdateSetterField, onUpdateCloserField, onFastBook, onDeleteLead, canDelete, canEditSetterSteps, canEditCloserSteps }: CRMGridProps) {
                                    ...
                                    <div className="flex items-center justify-end gap-2">
                                        {onFastBook && (
                                            <button 
                                                ...
                                                className="text-[10px] font-bold px-3 py-1.5 rounded transition flex items-center justify-center gap-1.5 whitespace-nowrap"
                                        ...
                                        {canDelete && onDeleteLead && (
                                            <button
                                                onClick={(e) => {
                                                    e.stopPropagation()
                                                    if (!confirm(`Eliminare "${lead.name}"? Azione irreversibile.`)) return
