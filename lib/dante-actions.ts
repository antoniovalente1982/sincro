...
// --- Creative Pipeline: rimosso (modulo Ads/Creative dismesso) ---

async function forceRunPipeline(_orgId: string): Promise<ActionResult> {
    return {
        success: false,
        message: '⚠️ Il modulo Creative Pipeline è stato rimosso. Questa funzione non è più disponibile.'
    }
}
...
// --- Creative Pipeline: Approve/Reject Ad Creatives — rimosso ---

// eslint-disable-next-line @typescript-eslint/no-unused-vars
const META_API = 'https://graph.facebook.com/v21.0'

async function approveCreative(_orgId: string, _params: Record<string, any>, _newStatus: 'approved' | 'rejected'): Promise<ActionResult> {
    return {
        success: false,
        message: '⚠️ Il modulo Creative Studio è stato rimosso. Approva/rifiuta le creative direttamente su Meta Ads Manager.'
    }
}
